(() => {
  ...
  document.querySelector("[data-review-prev]")?.addEventListener("click", () => scrollTrack(reviewsTrack, -1));
  document.querySelector("[data-review-next]")?.addEventListener("click", () => scrollTrack(reviewsTrack, 1));
